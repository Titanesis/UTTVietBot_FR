...
class VietBot(object):
    ...
    def _create_today_menu(self, dish):
        menu_of_the_day = u"Aujourd'hui, tu peux manger {0}.".format(dish)
        return menu_of_the_day

    def _create_day_menu(self, day, dish):
        menu_of_the_day = u"{0}, tu pourras manger {1}.".format(day, dish)
        return menu_of_the_day
    ...
    def askmenu_callback(self, hermes, intent_message):
        ...
        en_fr_dict = {
            u"Monday": u"Lundi",
            u"Tuesday": u"Mardi",
            u"Wednesday": u"Mercredi",
            u"Thursday": u"Jeudi",
            u"Friday": u"Vendredi"
        }

        menu_dict = {
            u"Monday": u"des boulettes de boeuf ou du poulet aux légumes",
            u"Tuesday": u"du poulet rôti ou du porc sauce piquante",
            u"Wednesday": u"du boeuf aux légumes ou des crevettes aigre-douce",
            u"Thursday": u"du poulet au curry ou du canard à l'ananas",
            u"Friday": u"des boulettes de porc ou du poisson aigre-doux"
        }
        ...
        hermes.publish_start_session_notification(intent_message.site_id, sentence, u"VietBot_FR")
